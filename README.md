...
2. **Denoise** with the target prompt, blending source and target velocities via Trajectory Interpolation
3. **Steer** the edit using Adaptive Masking — combining velocity-difference masks with concept-guided SAM3 segmentation for precise spatial control
